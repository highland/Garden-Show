...
#  Dec 21, 2022 07:01:16 PM GMT  platform: Windows NT
set vTcl(timestamp) ""
...
### SPOT dump_widget_opt A
    bind $top.tEn48 <FocusOut> {
        check_existing_exibitor
    }
    ttk::label "$top.tLa49" \
        -background $vTcl(actual_gui_bg) -foreground $vTcl(actual_gui_fg) \
...
### SPOT dump_widget_opt A
    ...
    ttk::button "$top.tBu51" \
        -takefocus {} -text "Add" -compound left 
    vTcl:DefineAlias "$top.tBu51" "AddButton" vTcl:WidgetProc "Toplevel1" 1
### SPOT dump_widget_opt A
    bind $top.tBu51 <Button-1> {
        create_entry
    }
    listbox "$top.lis47" \
        -background white -disabledforeground #a3a3a3 -font "TkFixedFont" \
        -foreground $vTcl(actual_gui_fg) -height 232 -selectmode single \
        -width 454 
    $top.lis47 configure -font "TkFixedFont"
    $top.lis47 insert end text
    vTcl:DefineAlias "$top.lis47" "Entries" vTcl:WidgetProc "Toplevel1" 1
### SPOT dump_widget_opt A
    bind $top.lis47 <<ListboxSelect>> {
        entry_selected
    }
    ###################
    # SETTING GEOMETRY
    ...
    place $top.tCo54 \
        -in $top -x 0 -relx 0.7 -y 0 -rely 0.267 -width 0 -relwidth 0.072 \
        -height 0 -relheight 0.047 -anchor nw -bordermode ignore 
    place $top.tLa55 \
        -in $top -x 0 -relx 0.117 -y 0 -rely 0.267 -width 0 -relwidth 0.525 \
        -height 0 -relheight 0.042 -anchor nw -bordermode ignore 
    place $top.lab56 \
    ...
    place $top.lab57 \
        ...
        -height 0 -relheight 0.047 -anchor nw -bordermode ignore 
    place $top.lab58 \
        -in $top -x 0 -relx 0.7 -y 0 -rely 0.2 -width 0 -relwidth 0.073 \
        -height 0 -relheight 0.047 -anchor nw -bordermode ignore 
    place $top.tBu47 \
    ...
    place $top.tLa50 \
        ...
        -height 0 -relheight 0.064 -anchor nw -bordermode ignore 
    place $top.tBu51 \
        -in $top -x 0 -relx 0.833 -y 0 -rely 0.267 -width 66 -relwidth 0 \
        -height 25 -relheight 0 -anchor nw -bordermode ignore 
    place $top.lis47 \
        -in $top -x 0 -relx 0.033 -y 0 -rely 0.333 -width 0 -relwidth 0.757 \
